...
# ps aux | grep "configs/vitdet/ppyoloe_r5" | awk '{print $2}' | xargs kill -9 

#  fleetrun --selected_gpu 0,1,2,3 tools/train.py -c configs/vitdet/ppyoloe_r50_msdcn_36e_coco.yml --eval &> logs_r50.txt 2>&1 &
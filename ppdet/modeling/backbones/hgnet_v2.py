...
#from ..base.theseus_layer import nn.Layer
...
class HG_Block(nn.Layer):
    def __init__(self,
        ...
        block_type = "ConvBNAct_dw" if dw_block else "ConvBNAct"
...
def PPHGNet_small_dw_0111(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, True, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0001(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    stage_config = {
        # in_channels, mid_channels, out_channels, blocks, downsample, dw_block, dw_kernel_size, act
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, False, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0011(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
...
def PPHGNet_small_dw_0011_swish_0011(pretrained=False, use_ssld=False,
                                     **kwargs):
    """
    PPHGNet_small
    Args:
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 3, "Swish"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "Swish"],
    }
...
def PPHGNet_small_dw_0011_k_3355(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 5, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 5, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_k_3357(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    stage_config = {
        ...
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 5, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 7, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_k_3377(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 7, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 7, "ReLU"],
    }
...
def PPHGNet_small_dw_1111_k_5555(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    stage_config = {
        # in_channels, mid_channels, out_channels, blocks, downsample, dw_block, dw_kernel_size, act
        "stage1": [128, 128, 256, 1, False, True, 5, "ReLU"],
        "stage2": [256, 160, 512, 1, True, True, 5, "ReLU"],
        "stage3": [512, 192, 768, 2, True, True, 5, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 5, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_act_True_False(pretrained=False,
                                         use_ssld=False,
                                         **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_True_False_swish_0011(pretrained=False,
                                                    use_ssld=False,
                                                    **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_False_True(pretrained=False,
                                         use_ssld=False,
                                         **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_False_True_1141(pretrained=False,
                                              use_ssld=False,
                                              **kwargs):
    """
    PPHGNet_small
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 4, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_act_False_True_1151(pretrained=False,
                                              use_ssld=False,
                                              **kwargs):
    """
    PPHGNet_small
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 5, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_act_False_True_1161_fuse_v1(pretrained=False,
                                                      use_ssld=False,
                                                      **kwargs):
    """
    PPHGNet_small
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 6, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_act_False_True_1151_fuse_v1(pretrained=False,
                                                      use_ssld=False,
                                                      **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_False_True_1141_fuse_v1(pretrained=False,
                                                      use_ssld=False,
                                                      **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_False_True_1131_fuse_v1(pretrained=False,
                                                      use_ssld=False,
                                                      **kwargs):
    """
    PPHGNet_small
    ...
    stage_config = {
        ...
        "stage1": [128, 128, 256, 1, False, False, 3, "ReLU"],
        "stage2": [256, 160, 512, 1, True, False, 3, "ReLU"],
        "stage3": [512, 192, 768, 3, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 1, True, True, 3, "ReLU"],
    }
...
def PPHGNet_small_dw_0011_act_False_True_1121_fuse_v1(pretrained=False,
                                                      use_ssld=False,
                                                      **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_0011_act_False_True_swish_0011(pretrained=False,
                                                    use_ssld=False,
                                                    **kwargs):
    """
    PPHGNet_small
...
def PPHGNet_small_dw_1252(pretrained=False, use_ssld=False, **kwargs):
    """
    PPHGNet_small
    Args:
        pretrained: bool=False or str. If `True` load pretrained parameters, `False` otherwise.
    ...
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, blocks, downsample, dw_block, dw_block, dw_kernel_size, act
        "stage1": [128, 128, 256, 1, False, True, 3, "ReLU"],
        "stage2": [256, 160, 512, 2, True, True, 3, "ReLU"],
        "stage3": [512, 192, 768, 5, True, True, 3, "ReLU"],
        "stage4": [768, 224, 1024, 2, True, True, 3, "ReLU"],
    }
...
if __name__ == "__main__":
    net = PPHGNet_small_dw_0011_act_False_True_1161_fuse_v1()
    ...
    paddle.jit.save(
        model,
        f"./inference/PPHGNet_small_dw_0011_act_False_True_1161_fuse_v1/inference"
    )

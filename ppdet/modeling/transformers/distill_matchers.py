...
__all__ = ['DistillHungarianMatcher']
...
class DistillHungarianMatcher(nn.Layer):
    ...
    def __init__(self,
        ...
        """
        super(DistillHungarianMatcher, self).__init__()
    ...
    def forward(self,
        ...
        Args:
            ...
            gt_score (List(Tensor)): list[[n, 1]]
            gt_logits (Tensor): [b, query_k, num_classes]

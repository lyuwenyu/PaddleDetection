...
@register
@serializable
class Obj365DataSet(DetDataset):
    """
    ...
    def __init__(self,
        ...
        super().__init__(dataset_dir, image_dir, anno_path, data_fields,
                         sample_num)
    ...
    def parse_dataset(self):
        ...
        # TODO
        cache_file = os.path.join(self.dataset_dir, self.cache_file)
        if self.use_cache and os.path.exists(cache_file):
            self.roidbs = pickle.load(open(cache_file, 'rb'))
            return
        ...
        for img_id in img_ids:
            ...
            # TODO
            im_fname = img_anno['file_name'][10:]
        ...
        if self.use_cache:
            pickle.dump(self.roidbs, open(cache_file, 'wb'))
